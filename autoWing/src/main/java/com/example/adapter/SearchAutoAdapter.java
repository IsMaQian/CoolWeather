...
import com.example.autowing.SettingActivity;
...
public class SearchAutoAdapter extends BaseAdapter {
	...
	private ArrayList<SearchAutoData> mOriginalValues;                                                                                                                                                                                                                                // �?有的Item
...
//		holder.addButton.setOnClickListener(mOnClickListener);
	...
	public void initSearchHistory() {
		SharedPreferences sp = mContext.getSharedPreferences(
				SettingActivity.SEARCH_HISTORY, 0);
		String longhistory = sp.getString(SettingActivity.SEARCH_HISTORY, "");
